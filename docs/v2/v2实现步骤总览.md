...
| 步骤编号 | 步骤名称 | 实施细则（真源） |
|---:|---|---|
| 16 | 项目结构与类型定义（Vite） | `docs/v2/v2实施细则/16-前端项目结构与类型定义-细则.md` |
...
| 步骤编号 | 步骤名称 | 泳道 | 依赖 | Reuse Type | 交付对象 | 验收锚点 | 风险点/注意事项 |
|---:|---|---|---|---|---|---|---|
| 05 | 产品表 + Product Service | B | 01 | R2 | products 表 + API(读) | Data Product | 写入由内部链路承接 |
| 06 | 保单表 + Policy Service | B | 05 | R2 | policies 表 + API(读) | Data Product | 写入由内部任务/修复链路承接 |
| 07 | 天气数据表 + Weather Service | B | 01 | R2 | weather_data 表 + API | Data Product | Mock 生成 + 未来真实接口 |
...
| 步骤编号 | 步骤名称 | 泳道 | 依赖 | Reuse Type | 交付对象 | 验收锚点 | 风险点/注意事项 |
|---:|---|---|---|---|---|---|---|
| 16 | 项目结构与类型定义（Vite） | C | 01 | R1 | 前端项目骨架 | — | Zustand + TanStack Query |
...
Phase 2: 前端联动
┌──────────────────────────────────────────────────────────────┐
│  [16] Vite 骨架 ─────→ [17] Maps 初始化 ──→ [18] Map Stage     │
│                              ↓                                │
