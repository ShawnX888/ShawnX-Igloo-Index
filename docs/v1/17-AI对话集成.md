...
- 当前参数状态：`selectedRegion`、`dataType`、`dateRange`、`selectedProduct`
...
3. **参数提取和设置**
   - 从AI对话结果中提取参数
   - 更新全局状态（selectedRegion、dataType、dateRange、selectedProduct）
   - 触发数据重新计算和地图重新渲染
